...
exports.VtbMapElement = exports.VtbMapMarkerGroupElement = exports.VtbMapMarkerElement = void 0;
...
exports.VtbMapMarkerElement = VtbMapMarkerElement;
VtbMapMarkerElement.styles = (0, lit_1.css) `
    :host {
      display: none;
    }
  `;
...
exports.VtbMapMarkerElement = VtbMapMarkerElement = tslib_1.__decorate([
    (0, decorators_js_1.customElement)('vtb-map-marker')
], VtbMapMarkerElement);
let VtbMapMarkerGroupElement = class VtbMapMarkerGroupElement extends lit_1.LitElement {
    get connectMarkers() {
...
exports.VtbMapMarkerGroupElement = VtbMapMarkerGroupElement;
VtbMapMarkerGroupElement.styles = (0, lit_1.css) `
    :host {
      display: none;
    }
  `;
tslib_1.__decorate([
    (0, decorators_js_1.property)({ type: Boolean, attribute: 'connect-markers' })
], VtbMapMarkerGroupElement.prototype, "connect_markers", void 0);
tslib_1.__decorate([
    (0, decorators_js_1.property)({ type: String, attribute: 'connect-mode' })
...
exports.VtbMapMarkerGroupElement = VtbMapMarkerGroupElement = tslib_1.__decorate([
    (0, decorators_js_1.customElement)('vtb-map-marker-group')
], VtbMapMarkerGroupElement);
let VtbMapElement = class VtbMapElement extends lit_1.LitElement {
    set apiKey(value) {
        this.api_key = value;
    }
    get apiKey() {
    ...
    render() {
        ...
        return (0, lit_1.html) `
      <div id="map" style="${(0, style_map_js_1.styleMap)(containerStyles)}">
        Initializing map...
      </div>
    `;
    }
...
exports.VtbMapElement = VtbMapElement;
VtbMapElement.styles = (0, lit_1.css) `
    :host {
      display: block;
    }
  ...
  `;
tslib_1.__decorate([
    (0, decorators_js_1.property)({ type: String, attribute: 'api-key' })
...
tslib_1.__decorate([
    (0, decorators_js_1.property)({ type: Boolean, attribute: 'infowindow-enabled' })
...
tslib_1.__decorate([
    (0, decorators_js_1.query)('div#map')
], VtbMapElement.prototype, "_container", void 0);
exports.VtbMapElement = VtbMapElement = tslib_1.__decorate([
    (0, decorators_js_1.customElement)('vtb-map')
], VtbMapElement);
// test
