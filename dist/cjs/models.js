...
const duration_1 = require("dayjs/plugin/duration");
...
exports.VtbParty = VtbParty;
class VtbMedia {
    constructor() {
        this.tags = [];
    }
}
exports.VtbMedia = VtbMedia;
class VtbExtraField {
    constructor() {
        this.name = '';
    }
...
exports.VtbExtraField = VtbExtraField;
class VtbFlight {
    constructor() {
...
exports.VtbFlight = VtbFlight;
class VtbFlightCarrier {
}
exports.VtbFlightCarrier = VtbFlightCarrier;
class VtbFlightData {
}
exports.VtbFlightData = VtbFlightData;
class VtbParticipantPrice {
    constructor() {
        this.participant_id = 0;
        this.price = 0.0;
    }
}
exports.VtbParticipantPrice = VtbParticipantPrice;
class VtbElement {
    constructor() {
        this.id = '';
        this.title = '';
...
exports.VtbElement = VtbElement;
class VtbElementGroup {
    constructor() {
        this.id = '';
        this.nights = 0;
        this.hidden = false;
...
exports.VtbElementGroup = VtbElementGroup;
class VtbGeoLocation {
    constructor() {
        this.lat = 0.0;
        this.lng = 0.0;
    }
}
exports.VtbGeoLocation = VtbGeoLocation;
class VtbMapMarker extends VtbGeoLocation {
}
exports.VtbMapMarker = VtbMapMarker;
class VtbMapMarkerGroup {
    constructor() {
...
exports.VtbMapMarkerGroup = VtbMapMarkerGroup;
class VtbTravelPlanData {
    constructor() {
        this.title = '';
        this.subtitle = '';
        this.covers = [];
...
exports.VtbTravelPlanData = VtbTravelPlanData;
